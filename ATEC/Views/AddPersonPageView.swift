...
struct AddPersonPageView: View {
    ...
    @State private var avatar: UIImage = UIImage(named: "lightAvatarTemp\(Int.random(in: 1..<5))")!
                ...
                VStack(spacing: 16) {
                    ...
                    ScrollView(.horizontal, showsIndicators: false) {
                        HStack(spacing: 10) {
                            ...
                            ForEach(1..<5) { imageNum in
                                let avatarTemp: String = isDarkMode ? "darkAvatarTemp" : "lightAvatarTemp"
